...
export default function Irene() {
  ...
  async function sendPromt(category) {
    const promt = `Recomend me cultural places for ${city} in the category: ${category}. Provide a description of each place, and include the following data for each: what is the main interest of the place, price for entrance, and timetable. Return the answer as a valid JSON list, structured as follows:
[
  {
    "name": "Place Name",
    ...
    setAnswer(JSON.stringify(parsedResponse, null, 2));
  }

  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-md rounded-lg p-8 w-96">
        <h2 className="text-2xl text-slate-600 font-bold text-center mb-6">Best Cultural Places</h2>
        <select
